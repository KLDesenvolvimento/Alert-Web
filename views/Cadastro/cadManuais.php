<?php
	...
	// 	{//inicio do if
	// 		echo " <script> alert('Cadastro realizado com sucesso!'); window.location.href = 'http://localhost/alert_web/views/Cadastro/cadManuais.php'; </script> ";
	// 	}//ifm do if
	// 	else if($resposta == 'erro')//se for igual a erro exibe a seguinte mensagem
	// 	{//inicio do else if
	// 		echo " <script> alert('Erro ao cadastrar!'); window.location.href = 'http://localhost/alert_web/views/Cadastro/cadManuais.php'; </script> ";
	// 	}//fim do else if
